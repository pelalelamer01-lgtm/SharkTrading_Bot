...
# ================= 2. إعدادات باينانس المباشرة (سيرفر أوروبي مستقر) =================
            ...
            if update.message and str(update.message.chat_id) == CHAT_ID and update.message.text:
                ...
                if "balance" in text:
                    try:
                        ...
                        await send_telegram_msg(f"⚠️ فشل جلب الرصيد من السيرفر الأوروبي المباشر: {binance_err}")
...
async def main_bot_loop():
    ...
    await send_telegram_msg("🇪🇺 انطلاق حقيقي ومباشر من خوادم أوروبا الصافية!\n\n💵 اكتب الآن: balance\nوشوف السرعة الصاروخية للرد!")
