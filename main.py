...
# ================= 2. إعدادات باينانس التجريبية مع البروكسي لتخطي الحظر الجغرافي =================
...
# استخدام بروكـسي أوروبي مفتوح ومستقر لتفادي قيد الـ US West على ريلواي
PROXY_URL = "http://85.26.146.161:80" 
            ...
            if update.message and str(update.message.chat_id) == CHAT_ID and update.message.text:
                ...
                if "balance" in text:
                    try:
                        ...
                        await send_telegram_msg(f"⚠️ فشل جلب الرصيد. بنجرب بروكسي بديل.. الخطأ: {binance_err}")
...
# ================= 4. خوارزمية السيولة ومصيدة الحيتان (مستحيل نغيرها) =================
...
# ================= 6. إدارة الصفقات التلقائية (TP/SL) بـ 1 لوت =================
...
async def main_bot_loop():
    ...
    await send_telegram_msg("🛡️ تم دمج البروكسي الأوروبي لتخطي جدار باينانس الناري الحاظر لأمريكا!\n\n💵 اكتب للوحش الآن: balance \nوشوف النتيجة.")
